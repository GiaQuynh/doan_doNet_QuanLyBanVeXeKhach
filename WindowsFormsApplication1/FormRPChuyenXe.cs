...
{
    public partial class FormRPChuyenXe : Form
    {
        Database db = new Database();
        SqlConnection conn;
        public FormRPChuyenXe()
        {
            InitializeComponent();
        ...
        private void crystalReportViewer1_Load(object sender, EventArgs e)
        {
            ...
            using (SqlDataAdapter adapter = new SqlDataAdapter(query, conn))
            {
                ...
                if (dtb.Rows.Count > 0)
                {
                    CrystalReportBaoCaoChuyenXe report = new CrystalReportBaoCaoChuyenXe(); // Create an instance of the Crystal Report
